...
public interface SalesService {
    ...
    // 상세조회
    SalesAll 				getInfoSales(String sales_Date, int client_No); // 수주 상세 정보 조회
    List<SalesProduct> 		getSalesProduct(String sales_Date, int client_No); // 수주 품목 상세 조회
    ...
    // 삭제
    // void 				deleteSales(String sales_Date, int client_No); // 수주 삭제
    // int 					deleteSalesProduct(SalesAll sales); // 수주 품목 삭제
