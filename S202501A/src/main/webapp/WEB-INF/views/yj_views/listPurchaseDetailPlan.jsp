...
<body>
	...
	<h1> 입고 예정 리스트 </h1>
     ...
     <div style="margin-top: 10px; margin-right: 20px">
     	<a href="/excel/purchaseDetailPlanExcel?startDate=${param.startDate}&endDate=${param.endDate}&client_name=${param.client_name}&req_delivery_date=${param.req_delivery_date}" class="btn btn-success">엑셀 다운로드</a>
        <button id="printSelection" class="btn-print">인쇄</button>
     </div>
	
	<!-- 다른점: 3. 액션 이동 -->
    <form action="listPurchaseDetailPlan">
