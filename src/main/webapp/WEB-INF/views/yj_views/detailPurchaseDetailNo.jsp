...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <!-- 전체 div -->
            <form action="/Logistics/purchaseDetailRestore" method="post" id="storeForm">
            <div class="detail-wrapper">
                <div class="detail-header">
                    <div>
                        <div class="detail-submenu">물류 관리 > 미입고 조회</div>
                ...
                <div class="detail-header-content">
                    <table class="detail-table">
                        ...
                        <tr>
                            <th>담당자</th><td>${purchase_details.emp_name }
                            <input type="hidden" name="emp_no" value="${purchase_details.emp_no}"></td>
                        </tr>
                        <tr>
