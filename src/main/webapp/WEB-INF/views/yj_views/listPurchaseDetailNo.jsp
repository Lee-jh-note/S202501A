        ...
        <div id="content">
            ...
            <div class="list-wrapper">
                <div class="list-header">
                    <div>
                        <div class="list-submenu">물류 관리 > 미입고 조회</div>
                ...
                <div class="list-header2">
                    ...
                    <div class="list-search-filters">
                        <form action="listPurchaseDetailNo" method="get"
                ...
                <table class="list-table" id="purchaseTable">
                    ...
                    <c:forEach var="purchase_details" items="${searchListPurchaseDetailNo}">
                        <tr>
                            ...
                            <td>
                                <a href="detailPurchaseDetailNo?purchase_date=${purchase_details.purchase_date}&client_no=${purchase_details.client_no}">${purchase_details.client_name}</a>
                            </td>
