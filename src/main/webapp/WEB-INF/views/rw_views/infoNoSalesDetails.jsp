	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			<div id="content">
				...
				<!-- 전체 div -->
				<form action="/Logistics/updateNoSalesStatus" method="post" id="updateForm">
					<div class="detail-wrapper">
						<div class="detail-header">
							<div>
								<div class="detail-submenu">물류 관리 > 미출고 조회</div>
						...
						<div class="detail-header-content">
							<table class="detail-table">
								<tr>
									<th>매출일자</th><td>${infoNoSalesDetails.sales_date}</td>
								</tr>
								<tr>
									<th>담당자</th><td>${infoNoSalesDetails.emp_name}</td>
								</tr>
								<tr>
									<th>거래처명</th><td>${infoNoSalesDetails.client_name}</td>
								</tr>
							</table>
							...
							<!-- sales_date, client_no는 모든 행에 공통이므로, 반복문 밖에서 hidden으로 딱 한번만 전송 -->
							<input type="hidden" name="sales_date" value="${infoNoSalesDetails.sales_date}"> <input type="hidden" name="client_no" value="${infoNoSalesDetails.client_no}">
							...
							<table class="detail-table">
								...
								<tbody>
									<c:forEach var="salesDetails" items="${infoNoSalesDetailsList}">
										<tr>
											<td><input type="checkbox" name="product_no" value="${salesDetails.product_no}"></td>
