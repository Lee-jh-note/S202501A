					...
					<div class="detail-wrapper">
						...
						<div class="detail-header-content">
							<table class="detail-table">
								<tr>
									<th>매출일자</th>
									<td>${infoNoSalesDetails.sales_date}</td>
								</tr>
								<tr>
									<th>담당자</th>
									<td>${infoNoSalesDetails.emp_name}</td>
								</tr>
								<tr>
									<th>거래처명</th>
									<td>${infoNoSalesDetails.client_name}</td>
								</tr>
							</table>
							...
							<!-- (1) sales_date, client_no는 모든 행에 공통이므로, 반복문 밖에서 hidden으로 딱 한 번만 전송 -->
