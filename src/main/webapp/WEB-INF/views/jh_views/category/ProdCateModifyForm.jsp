...
<form action="/Prod/Category/ModifyAct" method="post">
  ...
  <input type="hidden" id="topCategory" name="top_category" value="${category.top_category}" readonly><br><br>


  <input type="hidden" id="midCategory" name="mid_category" value="${category.mid_category}" readonly><br><br>
  ...
  <input type="text" id="content" name="content" value="${category.content}"><br><br>
