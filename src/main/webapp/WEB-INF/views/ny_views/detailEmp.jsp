...
<script>
        ...
        function handleDelete() {
            openModal("정말 삭제하시겠습니까?", () => {
                // 삭제 로직 실행
                location.href="/HR/deleteEmp?emp_No=${emp.emp_No}";
            });
        }
    </script>
<style type="text/css">
			...
			<div id="content">
				...
				<div class="detail-wrapper">
					<div class="detail-header">
						...
						<div>
							<input class="detail-empty-button" type="button" value="목록"
								onclick="location.href='/All/HR/listEmp'"> 
							<input class="btn detail-full-button" type="button" value="수정"
								onclick="location.href='/HR/updateFormEmp?emp_No=${emp.emp_No}'">
							<input class="btn detail-full-button" type="button" value="삭제"
